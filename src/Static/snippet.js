...
/***/ function(module, exports, __webpack_require__) {
	...
	comment = {
	  view: function() {
	    var cmt;
	    if (commentLoading || (sid == null)) {
	      return m('p', 'loading comment...');
	    } else {
	      return m('ul.CommentList', (function() {
	        var i, len, results;
	        results = [];
	        for (i = 0, len = commentArray.length; i < len; i++) {
	          cmt = commentArray[i];
	          results.push(m('li', m('.User', cmt.name), m('content', cmt)));
	        }
	        return results;
	      })());
	    }
	...
	commentForm = {
	  view: function() {
	    return [
	      m('p', 'Discuss'), m('textarea.CommentInput', {
