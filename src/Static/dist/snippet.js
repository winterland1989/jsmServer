...
/***/ function(module, exports, __webpack_require__) {
	...
	var aceMode, compiled, controlPanel, controlPanelDom, editor, language, m, s, sourceCode, toggleCompile;
	...
	controlPanel = {
	  view: function() {
	    if (language !== "javascript") {
	      return m('input.CompileToggle', {
	        type: 'submit',
	        onclick: toggleCompile,
	        value: compiled ? 'Don\'t compile' : 'Compile to js'
	      });
	    }
	  }
	};
